...
from table_agent.utils.utils import get_project_root
...
class PromptsTemplateGenerator:
    ...
    def __init__(
        ...
        *,
        ...
        template_dirs: Sequence[str] | None = [f'{get_project_root()}/promptstemplates/resources'],
    ) -> None:
        """
        Parameters
        ----------
        ...
        for mod_name in modules:
            try:
                if __package__:
                    ...
                    try:
                        mod = importlib.import_module(f'table_agent.promptstemplates.{mod_name}')
                    except ImportError:
