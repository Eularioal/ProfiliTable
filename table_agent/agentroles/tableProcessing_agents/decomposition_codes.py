...
# Agent Definition
# ----------------------------------------------------------------------
@register("decomposition_codes")
class DecompositionCodes(BaseAgent):
    """TODO: 描述 decomposition_codes 的职责"""
    ...
    def role_name(self) -> str:  # noqa: D401
        return "decomposition_codes"

    @property
    def system_prompt_template_name(self) -> str:
        return "system_prompt_for_decomposition_codes"
    @property
    def task_prompt_template_name(self) -> str:
        return "task_prompt_for_decomposition_codes"
    ...
    def get_task_prompt_params(self, pre_tool_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # TODO: 按需补充
        return {
            "decomposition_result": pre_tool_results.get("decomposition_result", []),
...
async def decompositer_codes(
    ...
    **kwargs,
    ...
    """数据分析的入口函数"""
    decompositer = DecompositionCodes(
...
def create_decompositer_agent(tool_manager: Optional[ToolManager] = None, **kwargs) -> DecompositionCodes:
    """创建分解器代理实例"""
    return DecompositionCodes(tool_manager=tool_manager, **kwargs)